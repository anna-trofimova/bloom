...
export default function LandingPage() {
  ...
  const [tbfCurrent, setTbfCurrent] = useState(0);
  const [aiCurrent, setAiCurrent] = useState(0);
  ...
  const [tbfInst, setTbfInst] = useState(null);
  const [aiInst, setAiInst] = useState(null);
    ...
    <div className="min-h-screen bg-[var(--background)] text-[color:hsl(var(--foreground))]">
      ...
      <header className="relative z-[200] overflow-visible isolate">
        ...
        <nav className="relative z-10 mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          ...
          <div className="hidden gap-6 md:flex">
            <ProductsMenu />
            <a className="btn-ghost focus-ring" href="#testimonials">
              Reviews
            </a>
            <a className="btn-ghost focus-ring" href="#faq">
              FAQ
            </a>
          </div>
        </nav>
          ...
          <div>
            <div className="card-minimal p-4">
              <div className="card-soft p-4">
                ...
                <a
                  href="#bundles"
                  className="mt-4 block rounded-2xl border border-[hsl(var(--border))] bg-white/80 p-5 hover:shadow-md transition"
                >
      ...
      <section id="tools" className="bg-[hsl(var(--background))] py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <h2
            id="astrology"
            className="text-section-title text-center mb-6 scroll-mt-28"
          >
            Astrology Guides & Tools
          </h2>
          <p className="text-center text-[color:hsl(var(--muted-foreground))] mb-12 italic text-lg max-w-2xl mx-auto">
            Astrology doesn’t tell you who you are — it’s a mirror that reflects
            patterns, inviting you to notice what’s already moving within you
          ...
          <p className="text-center text-[color:hsl(var(--muted-foreground))] mb-12 italic text-lg max-w-2xl mx-auto">
            Traveling & Budgeting isn’t about limitation — it’s about awareness.
            It reflects how you spend, save and explore the world around you.
          </p>

          <ProductCarousel
            products={travelingbudgetProducts}
            onPreview={onPreview}
            CheckoutButton={CheckoutButton}
            showDots={false}
            onReady={setTbfInst}
            onSlideChanged={setTbfCurrent}
          />
          <div className="mb-16" />
          ...
          <p className="text-center text-[color:hsl(var(--muted-foreground))] mb-12 italic text-lg max-w-2xl mx-auto">
            A habit tracker doesn't make you disciplined — it's a mirror that
            shows the patterns of your days, inviting you to notice what's
          ...
          <p className="text-center text-[color:hsl(var(--muted-foreground))] mb-12 italic text-lg max-w-2xl mx-auto">
            A coloring book is more than pages to fill — it’s a mirror for your
            inner world, reflecting your moods and inviting you to slow down,
            breathe, and create.
          </p>
          ...
          <p className="text-center text-[color:hsl(var(--muted-foreground))] mb-12 italic text-lg max-w-2xl mx-auto">
            AI Products aren’t about replacing creativity — they’re about
            enhancing it. They reflect how you think, create, and solve problems
            in a faster, smarter way. We build simple AI-powered tools to help
            you work more efficiently and turn ideas into reality.
          </p>
          ...
          <p className="text-center text-[color:hsl(var(--muted-foreground))] mb-12 italic text-lg max-w-2xl mx-auto">
            Get more for less with our bundle options: curated sets that save
            you money and give you everything you need in one go.
          </p>
          ...
          <p className="text-center text-[color:hsl(var(--muted-foreground))] mb-12 italic text-lg max-w-2xl mx-auto">
            A small gift from us — free downloads to help you get started on
            your journey toward better habits, clarity, and growth.
          </p>
      ...
      <section id="testimonials" className="mx-auto max-w-6xl px-6 pb-20">
        <div className="card-minimal p-8">
          <h2 className="text-section-title text-center">
            Gentle words from early users
          </h2>
            ...
            return (
              <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
                {testimonials.map((t, i) => (
                  ...
                  >
                    <blockquote className="text-[color:hsl(var(--muted-foreground))]">
                      “{t.quote}”
                    </blockquote>
                    {t.name && (
          ...
          {[
            {
              ...
              a: (
                <>
                  Yes! We offer a selection of free downloads. You can explore
                  them in the{" "}
